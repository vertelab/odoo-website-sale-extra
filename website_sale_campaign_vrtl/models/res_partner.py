...
class Main(http.Controller):
    ...
    def producers(self, **post):
        ...
        return request.render('website_sale_campaign_vrtl.producers', {'countries': countries})
    ...
    def producer_products(self, partner_id=None, **post):
        ...
        return request.render('website_sale_campaign_vrtl.producer_products', {'supplier': partner, 'products': products})

    @http.route(['/country/<model("res.country"):country>'], type='http', auth="public", website=True)
    def res_country(self, country=None, **post):
        return request.render('website_sale_campaign_vrtl.country', {'country': country})
    ...
    def res_district(self, district=None, **post):
        return request.render('website_sale_campaign_vrtl.district', {'district': district})
